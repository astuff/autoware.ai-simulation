...
/**
 * @file wfsim_model_time_delay.hpp
 * @brief wf_siulator model with time delay and 1-dimensional dynamics for velocity & steeiring
 * @author Takamasa Horibe, Kim-Ngoc-Khanh Nguyen
 * @date 2019.08.17
 */

#ifndef WAYPOINT_FOLLOWER_WF_SIMULATOR_WFSIM_MODEL_TIME_DELAY_H_
#define WAYPOINT_FOLLOWER_WF_SIMULATOR_WFSIM_MODEL_TIME_DELAY_H_
...
/**
 * @class wf_simulator time delay twist model
...
public:
   ...
   */
  WFSimModelTimeDelayTwist(double vx_lim, double angvel_lim, double vx_rate_lim, double wz_rate_lim, double dt,
...
public:
   ...
   */
  WFSimModelTimeDelaySteer(double vx_lim, double steer_lim, double vx_rate_lim, double steer_rate_lim, double wheelbase,
